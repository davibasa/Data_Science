...
quantidade= int(input("Informe a quantidade de váriaveis do modelo: "))
x_ = list(range(0,quantidade))
y_ = list(range(0,quantidade))

print("Informe as ", quantidade, " váriaveis dependentes: ")
for n in range(0,quantidade):
    print("Informe o valor: ", n+1)
    y_[n] = int(input())

    
print("Informe as ", quantidade, " váriaveis independentes: ")
for n in range(0,quantidade):
    print("Informe o valor: ", n+1)
    x_[n] = int(input())
